...
:START_PROCESS
title 19045.4593_amd64_de-de_multi_6d014c9e download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=6d014c9e-61a2-431b-a229-bc7ea20518ba&pack=de-de&edition=core;professional&aria2=2"
